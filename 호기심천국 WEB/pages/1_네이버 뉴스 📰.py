...
# file_path1 = r'WEB_DATA/origin_NEWS.csv'
# file_path2 = r'WEB_DATA/datalab_NEWS.csv'
# file_path3 = r'WEB_DATA/sentences_NEWS.csv'

file_path1 = r'WEB_DATA/origin_NEWS_발표샘플.csv'
file_path2 = r'WEB_DATA/datalab_NEWS_발표샘플.csv'
file_path3 = r'WEB_DATA/sentences_NEWS_발표샘플.csv'
